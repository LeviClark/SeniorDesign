...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] CharacterDriverNetworkObject = null;
		...
		public GameObject[] PlayerDemoCubeNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			if (obj is CharacterDriverNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					...
					{
						if (CharacterDriverNetworkObject.Length > 0 && CharacterDriverNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(CharacterDriverNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<CharacterDriverBehavior>();
						}
					}
			...
			else if (obj is PlayerDemoCubeNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (PlayerDemoCubeNetworkObject.Length > 0 && PlayerDemoCubeNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(PlayerDemoCubeNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<PlayerDemoCubeBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateCharacterDriver instead, its shorter and easier to type out ;)")]
		public CharacterDriverBehavior InstantiateCharacterDriverNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CharacterDriverNetworkObject[index]);
			var netBehavior = go.GetComponent<CharacterDriverBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<CharacterDriverBehavior>().networkObject = (CharacterDriverNetworkObject)obj;
		...
		[Obsolete("Use InstantiatePlayerDemoCube instead, its shorter and easier to type out ;)")]
		public PlayerDemoCubeBehavior InstantiatePlayerDemoCubeNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(PlayerDemoCubeNetworkObject[index]);
			var netBehavior = go.GetComponent<PlayerDemoCubeBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<PlayerDemoCubeBehavior>().networkObject = (PlayerDemoCubeNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of CharacterDriver
		/// </summary>
		/// <returns>
		/// A local instance of CharacterDriverBehavior
		/// </returns>
		/// <param name="index">The index of the CharacterDriver prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public CharacterDriverBehavior InstantiateCharacterDriver(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CharacterDriverNetworkObject[index]);
			var netBehavior = go.GetComponent<CharacterDriverBehavior>();
		...
		/// <summary>
		/// Instantiate an instance of PlayerDemoCube
		/// </summary>
		/// <returns>
		/// A local instance of PlayerDemoCubeBehavior
		/// </returns>
		/// <param name="index">The index of the PlayerDemoCube prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public PlayerDemoCubeBehavior InstantiatePlayerDemoCube(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(PlayerDemoCubeNetworkObject[index]);
			var netBehavior = go.GetComponent<PlayerDemoCubeBehavior>();
